...
import (
	...
	"github.com/ironcd/philanthropy-os/tools/mail-indexer/internal/parse"
...
// Run connects, syncs, and idles until ctx is cancelled. Reconnects with backoff on error.
...
// idleUntilChange enters IDLE and returns (true, nil) when the server signals new
// messages, or (false, nil) on the periodic refresh (caller should re-enter).
